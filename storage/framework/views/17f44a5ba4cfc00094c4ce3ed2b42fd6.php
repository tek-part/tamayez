                        ...
                        <li>
                            <div class="menu-area">
                                <div class="header-btn d-block d-md-none">
                                    <a href="<?php echo e(route('login')); ?>" class="text-white"> الدخول </a>
                                    <a href="<?php echo e(route('website.book')); ?>" class="text-white">  ابدأ مشروع </a>
...
<?php /**PATH J:\Systems\تميز ERP\tamayez\resources\views/website/layouts/header.blade.php ENDPATH**/ ?>